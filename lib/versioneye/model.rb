module Versioneye
  class Model
    ...
    require 'versioneye/models/notification_watcher'
    require 'versioneye/models/notification_watcher_constraint'
    require 'versioneye/models/notification_watcher_config'
