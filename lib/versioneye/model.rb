module Versioneye
  class Model
    ...
    require 'versioneye/models/artifactory_connection'
    ...
    require 'versioneye/models/watcher'
    require 'versioneye/models/watcher_constraint'
    require 'versioneye/models/watcher_config'
