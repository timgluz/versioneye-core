...
test_case_url = "https://s3.amazonaws.com/veye_test_env/gradle_2/build.gradle"
...
describe GradleParser do
  ...
  describe "parse" do
    ...
    it "parse the file correctly" do
      product_1  = ProductFactory.create_for_maven("org.codehaus.groovy", "groovy-all", "2.4.3")
      product_2  = ProductFactory.create_for_maven("junit", "junit", "4.12")
      ...
      dependency_01 = fetch_by_name( project.dependencies, "groovy-all")
      ...
      dependency_01.version_requested.should eql("1.8.9")
      ...
      dependency_02.version_requested.should eql("4.12")
