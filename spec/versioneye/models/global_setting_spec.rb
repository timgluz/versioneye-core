...
describe GlobalSetting do
  ...
  describe 'set' do
    ...
    it 'changes the object' do
      ...
      described_class.set('test', 'SERVER_URL', 'http://localhost:8080').should be_truthy
      GlobalSetting.count.should == 1
      GlobalSetting.new.set('test', 'SERVER_URL', 'www.heise.de').should be_truthy
      GlobalSetting.count.should == 1
  ...
  describe 'keys' do
    ...
    it 'returns the keys' do
      described_class.new(:environment => 'test', :key => 'SERVER_URL',  :value => 'http://localhost:8080').save.should be_truthy
      described_class.new(:environment => 'test', :key => 'SERVER_PORT', :value => '8080').save.should be_truthy
