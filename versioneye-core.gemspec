...
# -*- encoding: utf-8 -*-
# stub: versioneye-core 0.5.7 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/versioneye/views/user_mailer/new_user_email.html.erb",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<octokit>, ["~> 3.0.0"])
      ...
      s.add_dependency(%q<octokit>, ["~> 3.0.0"])
