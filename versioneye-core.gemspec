...
# -*- encoding: utf-8 -*-
# stub: versioneye-core 5.14.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/versioneye/producers/bitbucket_repo_import_producer.rb",
    "lib/versioneye/producers/bitbucket_repos_import_producer.rb",
    "lib/versioneye/producers/common_crawl_producer.rb",
    "lib/versioneye/producers/common_producer.rb",
    "lib/versioneye/producers/github_repo_import_producer.rb",
    "lib/versioneye/producers/github_repos_import_producer.rb",
    ...
    "lib/versioneye/workers/bitbucket_repo_import_worker.rb",
    "lib/versioneye/workers/bitbucket_repos_import_worker.rb",
    "lib/versioneye/workers/common_crawl_worker.rb",
    "lib/versioneye/workers/common_worker.rb",
    "lib/versioneye/workers/github_repo_import_worker.rb",
    "lib/versioneye/workers/github_repos_import_worker.rb",
    ...
    "spec/fixtures/vcr_cassettes/ProjectUpdateService_update_all.yml",
    "spec/fixtures/vcr_cassettes/ProjectUpdateService_update_all_2.yml",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<bundler>, ["= 1.7.3"])
      ...
      s.add_runtime_dependency(%q<octokit>, ["~> 3.3.0"])
      ...
      s.add_runtime_dependency(%q<cocoapods-core>, ["~> 0.34.0.rc2"])
      s.add_runtime_dependency(%q<actionmailer>, ["~> 3.2.17"])
      s.add_runtime_dependency(%q<pdfkit>, ["~> 0.6.2"])
      s.add_runtime_dependency(%q<bunny>, ["~> 1.4.0"])
      ...
      s.add_dependency(%q<octokit>, ["~> 3.3.0"])
      ...
      s.add_dependency(%q<cocoapods-core>, ["~> 0.34.0.rc2"])
      s.add_dependency(%q<actionmailer>, ["~> 3.2.17"])
      s.add_dependency(%q<pdfkit>, ["~> 0.6.2"])
      s.add_dependency(%q<bunny>, ["~> 1.4.0"])
